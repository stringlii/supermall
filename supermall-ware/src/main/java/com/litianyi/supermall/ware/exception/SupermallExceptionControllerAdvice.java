package com.litianyi.supermall.ware.exception;
 ...
 */
@Slf4j
@RestControllerAdvice(basePackages = {"com.litianyi.supermall.ware.controller"})
public class SupermallExceptionControllerAdvice {
    ...
    public R handleException(Throwable throwable) {
        ...
        return R.error(BizCodeEnum.UNKNOWN_EXCEPTION).put("data", throwable);
    }
}
