package com.litianyi.supermall.product.exception;
 ...
 */
@Slf4j
@RestControllerAdvice(basePackages = {"com.litianyi.supermall.product.controller"})
public class SupermallExceptionControllerAdvice {
    ...
    public R handleException(Throwable throwable) {
        ...
        return R.error(BizCodeEnum.UNKNOWN_EXCEPTION).put("error", throwable);
    }
}
